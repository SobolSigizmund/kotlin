...
public class EnumEntrySyntheticClassDescriptor extends ClassDescriptorBase {
    ...
    private class EnumEntryScope extends MemberScopeImpl {
        ...
        public EnumEntryScope(@NotNull StorageManager storageManager) {
            this.functions = storageManager.createMemoizedFunction(Collections.<SimpleFunctionDescriptor>emptyList(), new Function1<Name, Collection<SimpleFunctionDescriptor>>() {
                @Override
