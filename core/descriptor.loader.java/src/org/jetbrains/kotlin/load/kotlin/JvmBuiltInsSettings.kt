...
open class JvmBuiltInsSettings(
    ...
    private val notConsideredDeprecation = storageManager.createLazyValue {
                ...
                additionalMember.newCopyBuilder().apply {
                    ...
                    when (memberStatus) {
                        JDKMemberStatus.BLACK_LIST -> {
                            if (!classDescriptor.isSuperCallPossible) return@mapNotNull null
    ...
    val ClassDescriptor.isSuperCallPossible: Boolean get() = !isFinalClass && fqNameSafe != KotlinBuiltIns.FQ_NAMES.annotation
                ...
                object : DFS.AbstractNodeHandler<ClassDescriptor, JDKMemberStatus>() {
                    override fun beforeChildren(javaClassDescriptor: ClassDescriptor): Boolean {
                        ...
                        when (signature) {
                            ...
                            in COLLECTION_TO_ARRAY_SIGNATURES -> { result = JDKMemberStatus.DROP }
                        }
    ...
    companion object {
        ...
        val COLLECTION_TO_ARRAY_SIGNATURES: Set<String> =
