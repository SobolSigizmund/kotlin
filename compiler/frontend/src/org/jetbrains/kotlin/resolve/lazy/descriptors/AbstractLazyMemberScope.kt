...
protected constructor(
    ...
    private val functionDescriptors: MemoizedFunctionToNotNull<Name, Collection<SimpleFunctionDescriptor>> = storageManager.createMemoizedFunction(emptyList()) { doGetFunctions(it) }
